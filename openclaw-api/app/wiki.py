...
WIKI_MODEL = "nvidia/llama-3.3-nemotron-super-49b-v1:free"
...
WIKI_FALLBACK_MODEL = "nvidia/llama-3.3-nemotron-super-49b-v1:free"  # Fallback if primary is rate-limited
