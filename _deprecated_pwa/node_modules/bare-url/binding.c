...
static js_type_tag_t ba<RESEND_API_KEY> = {0x6f1fd92f476698b0, 0x93b59c349143ee50};
...
#define V(name, fn) \
  ...
  V("parse", ba<RESEND_API_KEY>)
  V("canParse", ba<RESEND_API_KEY>)
#undef V

  return exports;
}

BARE_MODULE(bare_url, ba<RESEND_API_KEY>)
