...
For browser versions in `@mdn/browser-compat-data` that were released before Baseline can be defined, i.e. Baseline 2015, the `year` property is always the string: `"p<RESEND_API_KEY>"`.
...
...
"chrome","24","p<RESEND_API_KEY>","","2013-01-10","NULL","NULL"
...
