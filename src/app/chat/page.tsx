...
export default function ChatPage() {
 ...
 <div className="flex flex-col h-screen bg-background">
  ...
  {/* ── Messages ─────────────────────────────────────── */}
  <main className="flex-1 overflow-y-auto px-0 md:">
  <Conversation className="h-full">
   ...
   {messages.length === 0 ? (
    ...
    <div className="flex flex-col bg-background">
     ...
     <h2 className="text-xl font-extrabnew tracking-tight .5 text-on-surface">
      ...
      <Message from="assistant">
       ...
       <div className="relative z-10">
        ...
        if (part.type === 'reasoning') {
         return (
         <div key={`${message.id}-reason-${i}`} className="">
        ...
        if (part.type.startsWith('tool-')) {
         ...
         <div key={`${message.id}-tool-${i}`} className="mt-3">
          ...
          <SubagentStatus data={subagentData} className="" />
          )}
          <Tool>
          <ToolHeader
           type={tp.type}
  ...
  {/* ── Input area ───────────────────────────────── */}
  <div className="shrink-0 px-4 md: bg-gradient-to-t from-background via-background/90 to-transparent relative z-40">
  {/* Recording indicator */}
