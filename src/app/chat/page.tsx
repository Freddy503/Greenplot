...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-dvh bg-background">
      ...
      {/* ── Messages ─────────────────────────────────────── */}
      <main className="pt-28 pb-48 md:pb-16 flex-1 min-h-0 overflow-hidden">
      ...
      {/* ── Input area ───────────────────────────────── */}
      <div className="shrink-0 px-4 pb-48 md:pb-20 pt-10 bg-gradient-to-t from-background via-background/90 to-transparent relative z-40">
        {/* Recording indicator */}
