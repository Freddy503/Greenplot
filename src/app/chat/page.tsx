...
export default function ChatPage() {
 ...
 return (
  <div className="flex flex-col h-screen bg-background">
   ...
   {/* ── Input area ───────────────────────────────── */}
   <div "shrink-0 px-4 pt-2 md: bg-gradient-to-t from-background via-background/90 to-transparent relative z-40" style={{ paddingBottom: "max(1rem, calc(env(safe-area-inset-bottom, 0px) + 4rem))" }}>
    {/* Recording indicator */}
