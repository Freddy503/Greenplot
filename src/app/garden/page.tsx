...
function SeedRow({ seed, allSeeds, onClick }: { seed: Seed; allSeeds: Seed[]; onClick: () => void }) {
 ...
 <TableRow className="border-b border-outline-variant/5 hover:bg-surface-container transition-colors cursor-pointer group" onClick={onClick}>
  ...
  <TableCell>
  <p className="text-sm font-bnew text-on-surface group-hover:text-primary transition-colors ">
   {seed.title}
  </p>
  {tags.length > 0 && (
...
export default function GardenPage() {
 ...
 <div className="h-screen flex flex-col bg-background">
  ...
  <main className="flex-1 overflow-y-auto px-4 md:">
  {/* Hero */}
  ...
  {!loading && !error && seeds.length > 0 && (
   ...
   className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl bg-surface-container border border-outline-variant/10 hover:bg-surface-container-high hover:border-primary/20 transition-all active:scale-[0.98] group"
   >
  ...
  {focusSeed && (
   ...
   <CardContent className="relative z-10 p-6">
    <Badge className="bg-secondary/20 text-secondary text-[10px] font-bnew uppercase tracking-widest border-0">
    Focus Seed
    </Badge>
    <h4 className="text-xl font-bnew text-on-surface ">{focusSeed.title}</h4>
