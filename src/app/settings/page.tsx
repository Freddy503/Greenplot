...
export default function SettingsPage() {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-background">
      <Header />
      <main className="pt-[max(4rem,calc(env(safe-area-inset-top,0px)+0.5rem))] pb-[max(5rem,calc(env(safe-area-inset-bottom,0px)+1.5rem))] px-4 max-w-2xl mx-auto w-full">
