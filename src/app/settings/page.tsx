...
const PIPELINE_JOBS = [
  { id: 'morning_spark',     label: 'Morning Idea Spark',  icon: 'light_mode',    description: 'Weather + one deep pattern from your research interests' },
  { id: 'daily_briefing',    label: 'Daily Briefing',       icon: 'newspaper',     description: 'Enterprise AI news + academic papers for your focus areas' },
  { id: 'reflection',        label: 'Evening Reflection',   icon: 'psychology',    description: 'Contrarian angle on today + one actionable move' },
  { id: 'weekly_eval',       label: 'Weekly Content Eval',  icon: 'assessment',    description: 'What stuck this week? Patterns + creative constraint' },
  { id: 'biweekly_challenge',label: 'Biweekly Challenge',   icon: 'emoji_events',  description: 'Cross-domain experiment: apply a concept from one field to another' },
]
       ...
       <div className="px-4 max-w-2xl mx-auto" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 8rem)' }}>
         ...
         <Tabs defaultValue="essentials">
           <TabsList className="w-full mb-6 bg-surface-container rounded-2xl p-1 h-auto grid grid-cols-4">
             <TabsTrigger value="essentials" className="rounded-xl text-[11px] font-semibold data-[state=active]:bg-white data-[state=active]:shadow-sm py-2">Essentials</TabsTrigger>
             <TabsTrigger value="garden" className="rounded-xl text-[11px] font-semibold data-[state=active]:bg-white data-[state=active]:shadow-sm py-2">Garden</TabsTrigger>
             <TabsTrigger value="integrations" className="rounded-xl text-[11px] font-semibold data-[state=active]:bg-white data-[state=active]:shadow-sm py-2">Connect</TabsTrigger>
             <TabsTrigger value="account" className="rounded-xl text-[11px] font-semibold data-[state=active]:bg-white data-[state=active]:shadow-sm py-2">Account</TabsTrigger>
           </TabsList>

           {/* ── Essentials ── */}
           <TabsContent value="essentials" className="space-y-6 mt-0">
             {/* Profile */}
             <section>
                 ...
                 <div className="flex items-start gap-3">
                   ...
                   <div className="flex-1">
                     ...
                     <div className="mt-2 space-y-1 text-[10px] text-on-surface-variant/70">
                       ...
                       <p>🔬 Academic + Research Digest — 07:00 &amp; 18:00 CET</p>
           ...
           <TabsContent value="integrations" className="space-y-6 mt-0">
             <section>
               <h2 className="text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant mb-2">Calendar</h2>
               <CalendarConnectCard />
             </section>

             {/* MCP Server — shown here when dev tools are unlocked, otherwise show unlock prompt */}
             <section>
               <h2 className="text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant mb-2">MCP Server</h2>
               {!showDevTools ? (
                 <div className="px-5 py-4 rounded-2xl bg-surface-container border border-outline-variant/10 space-y-3">
                   <div className="flex items-center gap-3">
                     ...
                     <div>
                       ...
                       <p className="text-[11px] text-on-surface-variant mt-0.5">Re-enter your password to access developer settings.</p>
                     </div>
                   </div>
                   ...
                   <div className="px-5 py-4 rounded-2xl bg-surface-container border border-outline-variant/10 space-y-4">
                     <div className="flex items-start gap-3">
                       ...
                       <div>
                         ...
                         <p className="text-[11px] text-on-surface-variant leading-relaxed mt-0.5">
                           Lets Claude Code and Cursor search your seeds and wiki while you code.
                         </p>
                       </div>
                     </div>
                     <div className="space-y-2">
      ...
      "env": {
        ...
        "GREENPLOT_TOKEN": "${token || '<paste-your-token>'}"
                     ...
                     <div className="space-y-1">
                       <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-wider">Available tools</p>
           ...
           <TabsContent value="account" className="space-y-6 mt-0">
             ...
             <section>
               ...
               {showDevTools ? (
                       ...
                       try {
                         ...
                         if (res.ok) {
                           if (data.errors?.length) {
                             ...
                             toast.success(`Fixed ${data.fixed} seed${data.fixed !== 1 ? 's' : ''}${data.remaining > 0 ? ` · ${data.remaining} remaining` : ' · all done!'}`)
                           }
                         } else {
                 ...
                 <p className="text-xs text-on-surface-variant/50 px-1">Unlock dev tools in the Connect tab.</p>
               )}
             </section>
